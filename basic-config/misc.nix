{ pkgs, ... }: {
  ...
  security.pki.certificates = [
    # fix GH-36
    # It is a problem with intermediate cert, we lack of full cert chain locally, so openssl can't trust site
    # see: https://support.globalsign.com/ca-certificates/intermediate-certificates/alphassl-intermediate-certificates
    ''
*.mexa.sh
=========
-----BEGIN CERTIFICATE-----
